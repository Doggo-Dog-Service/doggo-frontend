...
const {
  experienceTime,
  experienceLabel
} = useProvider(props.provider)
</script>

<template>
  <div class="bg-background-light border border-doggo-gray rounded-2xl h-40 mx-2 flex items-center">
    ...
    <div class="flex-1 flex flex-col items-center gap-1">
      ...
      <p class="text-sm text-gray-400">Experiência</p>
    </div>
  </div>
</template>
